...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'chefbot_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dawg/catkin_ws/src/Chefbot_ROS_pkg/chefbot/chefbot_bringup/${idir}'.  Ask the maintainer 'lentin <lentin@todo.todo>' to fix it.")
    endif()
